...
# 원본 이미지 폴더
input_folder = "C:/Code/CapstoneDesign/CapstoneDesign/steering_data_preprocessor/data/frames"

# 증강 이미지 저장 폴더
output_folder = "C:/Code/CapstoneDesign/CapstoneDesign/steering_data_preprocessor/data/augmented_frames"
...
for filename in os.listdir(input_folder):
    if filename.lower().endswith((".jpg", ".png", ".jpeg")):  # 다양한 이미지 파일 처리
        ...
        # ROI 설정 (상단 20% 제거)
        roi_top = int(height * 0.3)  # 상단 20%
        roi = image[roi_top:height, :]  # 상단 20% 제거 후 하단 영역만 남기기
